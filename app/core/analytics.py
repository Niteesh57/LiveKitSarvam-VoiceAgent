...
def get_analytics() -> dict:
    ...
    Returns:
        dict with total_calls, total_bookings, conversion_rate,
    ...
    # Count actual appointment bookings
    appointment_bookings = [b for b in bookings if b.get("type") == "appointment_booked"]
    total_bookings = len(appointment_bookings)

    # Conversion rate: bookings / total call interactions
...
def get_lead_analytics(phone: str) -> dict:
    ...
    appointments = [b for b in lead_entries if b.get("type") == "appointment_booked"]
...
def generate_report(period: str = "daily") -> dict:
    ...
    appointment_bookings = [e for e in period_entries if e.get("type") == "appointment_booked"]
    ...
    logger.info("Generated %s report: %d calls, %d bookings", period, total_calls, total_bookings)
